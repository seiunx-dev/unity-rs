...
const opened: Promise<UnityRs> = UnityRs.openWithOodle(
  "fixture.bundle",
...
// Keep one ordinary TypeScript consumer for every public UnityRs member.
...
function consumeEveryUnityRsMember(studio: UnityRs): void {
  ...
  void UnityRs.openWith("fixture.assets", openOptions);
  void UnityRs.openWithOodle(
    "fixture.bundle",
    (_input, expectedLength) => Buffer.alloc(expectedLength),
    openOptions,
  );
  void UnityRs.openAsync("fixture.assets", openOptions);
  void UnityRs.fromBuffer(
    new Uint8Array(),
    "memory.assets",
    1024,
    openOptions,
  );
  void UnityRs.fromBufferAsync(
    new Uint8Array(),
    "memory.assets",
    1024,
    openOptions,
  );
  void UnityRs.fromBuffers([], 1024, openOptions);
  void UnityRs.extract("fixture.bundle", "output", false);
...
void consumeEveryUnityRsMember;
