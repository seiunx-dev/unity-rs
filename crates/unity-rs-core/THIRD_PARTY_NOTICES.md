...
- **Vendored copy.** `crates/unity-rs-core/src/vendor/texture2ddecoder/`
...
- [`Team-Haruki/AssetStudio`](https://github.com/Team-Haruki/AssetStudio) (MIT)
  ...
  `crates/unity-rs-core/tests/dotnet_oracle.rs`.
...
- UnityPy's `helpers/ArchiveStorageManager.py` credits
  ...
  archive-storage scheme. `crates/unity-rs-core/src/unity_cn.rs` implements
