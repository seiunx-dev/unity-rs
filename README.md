...
against the managed implementation, covering every block-compressed format,
both Crunch dialects, Switch deswizzling padded and cropped, and a whole
Live2D package compared against the real managed extractor. The existing .NET
