...
整理出的主体提交已经推送；2026-08-25 最近一次绿色矩阵验证代码 head 为 `a589771`。收口改动及公开 runner 修复已进入
[PR #1](https://github.com/Team-Haruki/unity-rs/pull/1)。仓库现为 Public；常规 PR 矩阵
[32837570675](https://github.com/Team-Haruki/unity-rs/actions/runs/32837570675) 为 16 个实际 job 全绿、2 个手工发布条件 job 正常跳过、0 失败，
